document.addEventListener("DOMContentLoaded", () => {
    ...
    const textControls = {
        title: {
            ...
            sizeInput: document.getElementById("titleSizeInput"),
            sizeValue: document.getElementById("titleSizeValue"),
            boldToggle: document.getElementById("titleBoldToggle"),
            italicToggle: document.getElementById("titleItalicToggle"),
        ...
        subtitle: {
            ...
            sizeInput: document.getElementById("subtitleSizeInput"),
            sizeValue: document.getElementById("subtitleSizeValue"),
            boldToggle: document.getElementById("subtitleBoldToggle"),
            italicToggle: document.getElementById("subtitleItalicToggle"),
        ...
        date: {
            ...
            sizeInput: document.getElementById("dateSizeInput"),
            sizeValue: document.getElementById("dateSizeValue"),
            boldToggle: document.getElementById("dateBoldToggle"),
            italicToggle: document.getElementById("dateItalicToggle"),
        ...
        time: {
            ...
            sizeInput: document.getElementById("timeSizeInput"),
            sizeValue: document.getElementById("timeSizeValue"),
            boldToggle: document.getElementById("timeBoldToggle"),
            italicToggle: document.getElementById("timeItalicToggle"),
        ...
        location: {
            ...
            sizeInput: document.getElementById("locationSizeInput"),
            sizeValue: document.getElementById("locationSizeValue"),
            boldToggle: document.getElementById("locationBoldToggle"),
            italicToggle: document.getElementById("locationItalicToggle"),
        ...
        extra: {
            ...
            sizeInput: document.getElementById("extraSizeInput"),
            sizeValue: document.getElementById("extraSizeValue"),
            boldToggle: document.getElementById("extraBoldToggle"),
            italicToggle: document.getElementById("extraItalicToggle"),
    ...
    function updateTextSize(control) {
        if (!control.sizeInput) return;
        const size = Number(control.sizeInput.value);
        control.element.style.fontSize = `${size}px`;
        if (control.sizeValue) control.sizeValue.textContent = size;
    }

    function toggleTextStyle(control, tipo) {
        const boton = tipo === "bold" ? control.boldToggle : control.italicToggle;
        if (!boton) return;
        boton.classList.toggle("active");

        control.element.style.fontWeight = control.boldToggle && control.boldToggle.classList.contains("active") ? "bold" : "";
        control.element.style.fontStyle = control.italicToggle && control.italicToggle.classList.contains("active") ? "italic" : "";
    }
    ...
    Object.values(textControls).forEach((control) => {
        ...
        if (control.sizeInput) {
            control.sizeInput.addEventListener("input", () => updateTextSize(control));
        }

        if (control.boldToggle) {
            control.boldToggle.addEventListener("click", () => toggleTextStyle(control, "bold"));
        }
        if (control.italicToggle) {
            control.italicToggle.addEventListener("click", () => toggleTextStyle(control, "italic"));
        }
